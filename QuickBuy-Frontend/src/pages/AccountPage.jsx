...
//     <title>My Account - QuickBuy</title>
...
//         // Component: Header (Reused concept from Homepage)
//         const Header = () => (
...
//                             <i data-lucide="repeat" className="w-5 h-5 mb-1"></i>
//                             <span className="text-xs font-medium">Reorder</span>
//                         </div>
//                         <div className="flex flex-col items-center cursor-pointer hover:text-blue-600">
//                             <i data-lucide="heart" className="w-5 h-5 mb-1"></i>
...
//                                 <i data-lucide="user" className="w-5 h-5 mb-1"></i>
...
//                              <div className="relative">
//                                 <i data-lucide="shopping-cart" className="w-6 h-6 mb-1"></i>
...
//                 { id: 'address', label: 'Address Book', icon: 'map-pin' },
...
//             return (
//                 <div className="loyalty-card rounded-2xl p-6 md:p-8 text-white shadow-lg mb-8 relative overflow-hidden">
//                     {/* Decorative Circles */}
...
//                                 {/* Always show Loyalty Card on top for specific requirement */}
//                                 <LoyaltyCard />
...
//                                         <i data-lucide="hammer" className="w-12 h-12 mx-auto mb-3 opacity-50"></i>
